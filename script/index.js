...
const popupModal = async (petId) => {
    try {
        ...
        if (pet) {
            ...
            modalContent.classList = "modal-box";

            modalContent.innerHTML = `
                <div class="rounded-lg w-full border">
                    <img src=${pet.image} alt=${pet.pet_name} class="object-cover w-full rounded-lg">
                </div>

                <div class="text-[#6c6964]">
                    <h3 class="mt-4 mx-1 mb-2 text-xl font-bold text-black">${pet.pet_name || "N/A"}</h3>
                    <p class="flex gap-2 m-1">
                        ...
                        </svg> Breed: ${pet.breed || "N/A"}
                    </p>

                    <p class="flex gap-2 m-1">
                        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 10h16m-8-3V4M7 7V4m10 3V4M5 20h14a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1H5a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1Zm3-7h.01v.01H8V13Zm4 0h.01v.01H12V13Zm4 0h.01v.01H16V13Zm-8 4h.01v.01H8V17Zm4 0h.01v.01H12V17Zm4 0h.01v.01H16V17Z"/>
                        </svg> Birth: ${pet.date_of_birth || "N/A"}
                    </p>

                    <p class="flex gap-2 m-1">
                        <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-gray-800 dark:text-white" viewBox="0 0 48 48">
                            <defs>
                                <style>
                                .cls-1 {
                                    stroke-width: 0px;
                ...
                <div>
                    <h3 class="font-semibold">Detailed Information</h3>
                    <p class="text-[#6c6964] m-1">${pet.pet_details || "N/A"}$</p>
                </div>

                <form method="dialog" class="flex justify-between items-center mt-4">
                    <button class="btn w-full rounded-lg px-4 text-[#0E7A81] text-lg font-bold border-[#008a5626] hover:bg-[#0E7A81] hover:text-white">Cancel</button>
                </form>
            `;
    ...
    animals.forEach((animal) => {
        ...
        animalCard.innerHTML = `
            <div class="rounded-lg">
                <img src=${animal.image} alt=${animal.pet_name} class="object-cover w-[266px] h-[178px] rounded-lg">
            </div>
