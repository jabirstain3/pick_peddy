    ...
    animals.forEach((animal) => {
        ...
        animalCard.innerHTML = `
            <div class="rounded-lg">
                <img src=${animal.image} alt="" class="object-cover w-[266px] h-[178px] rounded-lg">
            </div>

            <div class="text-[#6c6964]">
                <h3 class="mt-4 mx-1 text-lg font-bold text-black">${animal.pet_name}</h3>
            ...
            <div class="flex justify-between items-center gap-4">
                <button class="btn rounded-lg border-[#008a5626] hover:text-[#0E7A81] hover:border-[#008a5626]">
